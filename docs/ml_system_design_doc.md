...
Обычно VLLM-модель при тестировании на открытых датасетах(напрмер, DocVQA, RusTitW, TextVQAval, InstructDoc, ChartQA) отвечает на общие вопросы самой разной направленности.
